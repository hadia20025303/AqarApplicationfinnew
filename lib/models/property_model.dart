...
class PropertyModel {
  ...
  factory PropertyModel.fromJson(Map<String, dynamic> json) {
    return PropertyModel(
      ...
      // معالجة السعر والمساحة بشكل آمن
      price: double.tryParse(json['price']?.toString() ?? '0') ?? 0.0,
      area: double.tryParse(json['area']?.toString() ?? '0') ?? 0.0,
      ...
      residentialDetails: json['residential_details'] != null
          ? ResidentialDetails.fromJson(
              json['residential_details'] as Map<String, dynamic>,
            )
          : null,
      commercialDetails: json['commercial_details'] != null
          ? CommercialDetails.fromJson(
              json['commercial_details'] as Map<String, dynamic>,
            )
          : null,
      industrialDetails: json['industrial_details'] != null
          ? IndustrialDetails.fromJson(
              json['industrial_details'] as Map<String, dynamic>,
            )
          : null,
...
class ResidentialDetails {
  ...
  factory ResidentialDetails.fromJson(Map<String, dynamic> json) {
    return ResidentialDetails(
      ...
      parkingSpaces:
          int.tryParse(json['parking_spaces']?.toString() ?? '0') ?? 0,
    );
  }
}
...
class IndustrialDetails {
  ...
  factory IndustrialDetails.fromJson(Map<String, dynamic> json) {
    return IndustrialDetails(
      warehouseSize:
          double.tryParse(json['warehouse_size']?.toString() ?? '0') ?? 0.0,
      powerCapacity: (json['power_capacity'] ?? '').toString(),
      ceilingHeight:
          double.tryParse(json['ceiling_height']?.toString() ?? '0') ?? 0.0,
