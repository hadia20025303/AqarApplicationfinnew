...
class PropertyCard extends StatelessWidget {
  ...
  Widget _buildTransactionType() {
    // تحديد النص والأيقونة واللون حسب النوع
    final isSale = property.transactionType == 'sale';
    final label = isSale ? 'بيع' : 'إيجار';
    final icon = isSale ? Icons.sell : Icons.receipt_long;
        ...
        Expanded(
          child: Text(
            property.location != null
                ...
                : 'الموقع غير محدد',
            style: TextStyle(
              color: property.location != null ? Colors.white60 : Colors.white38,
              fontSize: 13,
              fontFamily: 'Cairo',
              overflow: TextOverflow.ellipsis,
            ),
      ...
      child: const Column(
        ...
        children: [
          Icon(Icons.home_work_outlined,
              color: AppTheme.goldAccent, size: 45),
          SizedBox(height: 8),
          Text(
            'لا توجد صور',
            style: TextStyle(
