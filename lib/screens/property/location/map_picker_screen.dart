...
class _MapPickerScreenState extends State<MapPickerScreen> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        ...
        if (widget.initialSearchQuery != null &&
          ...
          _searchLocation(widget.initialSearchQuery!, autoSelectFirst: true);
        }
      }
    });
  }
  ...
  Future<void> _searchLocation(String query, {bool autoSelectFirst = false}) async {
  ...
  // اختيار نتيجة البحث وتحديث الخريطة
        ...
        children: [
          ...
          Padding(
            ...
            child: TextField(
              ...
              onChanged: (query) => _searchLocation(query, autoSelectFirst: false),
            ),
          ),
            ...
            child: FlutterMap(
              ...
              children: [
                TileLayer(
                  ...
                  userAgentPackageName: 'com.example.untitled2',
                ),
                MarkerLayer(
                  markers: [
                    Marker(
